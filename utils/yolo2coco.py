...
Date: 2024-03-30 10:42:41
LastEditors: annzstbl@tianhaoli1996@gmail.com
LastEditTime: 2024-03-30 16:05:01
FilePath: /DiffusionDet/yolo2coco.py
Description: 
    将yolov5 格式的标注转换为coco格式的标注
...
def yolo2coco(image_path, anno_path, save_path, json_name='train.json'):
    ...
    if os.path.exists(save_path):
        ...
        # give warning
        print("warning {} has already existed!".format(save_path))
    else:
    ...
    # 移除文件的后缀
    images_index = {os.path.splitext(os.path.basename(v))[0]: k for k, v in enumerate(images)}
...
if __name__ == '__main__':
    ...
    # test数据集
    # parser.add_argument('-ap', '--anno-path', type=str, default='/data3/litianhao/datasets/HOD3K/hsidetection/sa_information/labels/test', help='yolo txt path')
    # parser.add_argument('-s', '--save-path', type=str, default='/data3/litianhao/datasets/HOD3K/hsidetection/sa_information/annotations/', help='json save path')
    # parser.add_argument('--image-path', default='/data3/litianhao/datasets/HOD3K/hsidetection/sa_information/images/test')
    # parser.add_argument('--json-name', default='test.json')
    parser.add_argument('-ap', '--anno-path', type=str, default='/data3/litianhao/datasets/HOD3K/hsidetection/sa_information/labels/val', help='yolo txt path')
    parser.add_argument('-s', '--save-path', type=str, default='/data3/litianhao/datasets/HOD3K/hsidetection/sa_information/annotations/', help='json save path')
    parser.add_argument('--image-path', default='/data3/litianhao/datasets/HOD3K/hsidetection/sa_information/images/val')
    ...
    #     image_path = './imgs_val'
    #     json_name = 'val.json'
    #     yolo2coco(image_path, anno_path, save_path, json_name)